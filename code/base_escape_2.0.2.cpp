...
int main(int newe) {
	...
	if (newe == 1) {
		...
		cout << " 2222        0000 \n22  22      00  00\n   22       00  00\n 22         00  00\n222222  **   0000" << endl << "Start: ";
		cin >> strt;
	}
	if (newe == 0) {
		cout << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << endl << "Welcome to my updated version of base_escape_2.0\nStart\nLoad" << endl;
		cin >> con1;
	...
	if (strt != '0') {
		cout << "Welcome to my updated version of base_escape_2.0\nStart\nLoad" << endl;
		cin >> con1;
		if (con1[0] == 's' || con1[0] == 'S') {
			start(1);
		}
...
//второй этаж
void floor2(char floor2[25]) { //C  B  R  A
